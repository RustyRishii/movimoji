    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#E0E7FF] px-4 py-8 font-mono">
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8 md:mb-12">
          <h1
            className="text-4xl md:text-6xl font-black text-black mb-4 uppercase tracking-wider"
            style={{ textShadow: "4px 4px 1px #1e40af" }}
          >
            movimoji 🎬
          </h1>
        ...
        <div className="bg-[#FF90E8] border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] md:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] p-6 md:p-12 relative overflow-hidden">
          ...
          <div className="flex flex-col items-center gap-6 md:gap-8 relative z-10">
            <div className="w-full">
              <label className="block text-black font-bold mb-2 text-base md:text-lg uppercase">
                Input Text
              </label>
              <input
                autoFocus={true}
                ...
                disabled={isLoading}
                className={`w-full p-3 md:p-4 text-lg md:text-xl font-bold border-4 border-black focus:outline-none transition-all placeholder:text-gray-500 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] focus:translate-x-[2px] focus:translate-y-[2px] ${
                  isLoading
            ...
            <button
              ...
              className={`w-full px-6 py-3 md:px-8 md:py-4 text-lg md:text-xl font-black uppercase border-4 border-black transition-all duration-200 ${
                !text || text.trim() === "" || isLoading
        ...
        <div className="flex justify-center mt-8 md:mt-12">
          <p className="text-center text-xs md:text-sm font-bold text-black bg-white inline-block border-2 border-black px-4 py-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            ...
            <a
              target="_blank"
              href="https://rishi.fyi/"
              className="text-blue-600 hover:text-blue-800 underline decoration-4 decoration-yellow-400 underline-offset-4 ml-1"
            >
              {" "}
              @RUSTYRISHII
            </a>
